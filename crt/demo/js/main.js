$(function() {
  var VintageTxtTest = {
    ...
    intro : function intro() {
      var texts = ["EDUCATION\n BA with Distinction in Mathematics and Statistics (Graduated April 2014) Biology and Medical Sciences courses from University of Debrecen, Medical School\n"];
